...
# OPC UA
OPC_IP = CONFIG.get('OPC_UA', 'ip', fallback='10.130.112.61')
...
# SQL Server
DB_SERVER = CONFIG.get('SQL_SERVER', 'ip', fallback='10.130.254.210')
DB_PORT = CONFIG.getint('SQL_SERVER', 'porta', fallback=1600)
# Remove aspas mas MANTEM espacos (para bancos como " FMA_Seed_Loss")
DB_NAME = CONFIG.get('SQL_SERVER', 'database', fallback=' FMA_Seed_Loss').strip('"').strip("'")
